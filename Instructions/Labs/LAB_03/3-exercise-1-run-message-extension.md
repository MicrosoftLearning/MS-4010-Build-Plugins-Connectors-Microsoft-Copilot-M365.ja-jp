...
1. ポップアップ パネルで、インストールした **Northwind Inventory** アプリケーションを選択します 3️⃣。
  ...
  3 つのタブ 1️⃣ を含む検索ダイアログが表示されます。 **[製品在庫]** タブでは、名前で製品を検索できます。
...
- **_,,out_** - 在庫切れの製品を見つけます。

- **_,,on,London_** - ロンドンのサプライヤーから注文されている製品を見つけます。
...
1. **受信者** 1️⃣ と **件名** 2️⃣ を追加し、メッセージの本文 3️⃣ にカーソルを置きます。 何かを入力することもできます。 準備ができたら、ツール バー 4️⃣ の **アプリボタン**を選択します。
